...
class PreferenceUtils {
  ...
  ///set demo token
  setDemoToken(String? token) {
    _getStorage.write(StringPreferences.demoToken, token);
    printInfo(info: 'set_demo_token: $token');
  }

  ///get demo token
  String? getDemoToken() => _getStorage.read(StringPreferences.demoToken) ?? '';
